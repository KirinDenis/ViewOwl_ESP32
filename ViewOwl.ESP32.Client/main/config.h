...
/* Firmware build trigger: 2026-06-10a — v1.2.43 latch has_frame on player start; TUI log can no longer paint over content after a failed BATCH. */
